...
(function () {
  ...
  var CSS = [
    '.sd-launch{position:fixed;right:20px;bottom:20px;z-index:9998;display:flex;align-items:center;gap:9px;',
      'background:#B8860B;color:#1A1A18;border:0;border-radius:999px;padding:13px 19px;cursor:pointer;',
      'font:700 15px/1 Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;',
      'box-shadow:0 8px 26px -8px rgba(0,0,0,.7)}',
    '.sd-launch:hover{background:#cf9a12}',
    '.sd-launch:focus-visible{outline:2px solid #fff;outline-offset:3px}',
    '.sd-launch .sd-dot{width:9px;height:9px;border-radius:50%;background:#1A1A18;opacity:.55}',
    '.sd-panel{position:fixed;right:20px;bottom:20px;z-index:9999;width:min(380px,calc(100vw - 32px));',
      ...
      'background:#1A1A18;border:1px solid #2E2E2A;border-radius:18px;',
      'box-shadow:0 24px 60px -18px rgba(0,0,0,.85);',
      'font:400 15px/1.6 Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;color:#fff}',
    '.sd-panel.sd-open{display:flex}',
    '.sd-head{background:#111;padding:20px 20px 18px;border-bottom:1px solid #2E2E2A;flex:0 0 auto}',
    ...
    '.sd-av{width:34px;height:34px;border-radius:50%;background:#B8860B;color:#1A1A18;',
    ...
    '.sd-role{font-size:12px;color:#9E9E97;line-height:1.3}',
    '.sd-x{background:0;border:0;color:#9E9E97;font-size:22px;line-height:1;cursor:pointer;padding:4px 6px;border-radius:6px}',
    '.sd-x:hover{color:#fff}',
    '.sd-x:focus-visible{outline:2px solid #B8860B;outline-offset:2px}',
    '.sd-greet{font-size:19px;font-weight:800;letter-spacing:-.01em;margin:0 0 4px}',
    '.sd-greet-sub{font-size:13.5px;color:#9E9E97;margin:0}',
    '.sd-body{padding:16px 20px 20px;overflow-y:auto;flex:1 1 auto;-webkit-overflow-scrolling:touch}',
    '.sd-search{width:100%;box-sizing:border-box;background:#222220;border:1px solid #3a3a35;border-radius:11px;',
      'padding:12px 14px;color:#fff;font:inherit;font-size:14.5px;margin-bottom:6px}',
    '.sd-search::placeholder{color:#7d776a}',
    '.sd-search:focus{outline:0;border-color:#B8860B}',
    '.sd-list{list-style:none;margin:0;padding:0}',
    '.sd-item{border-bottom:1px solid #2a2a26}',
    '.sd-q{width:100%;text-align:left;background:0;border:0;color:#fff;font:inherit;font-size:14.5px;',
      'padding:13px 26px 13px 0;cursor:pointer;position:relative}',
    '.sd-q:hover{color:#E8B44A}',
    '.sd-q:focus-visible{outline:2px solid #B8860B;outline-offset:-2px;border-radius:4px}',
    '.sd-q::after{content:"\\203A";position:absolute;right:6px;top:50%;transform:translateY(-50%);color:#7d776a;font-size:19px}',
    '.sd-item.sd-on .sd-q::after{content:"\\2039";transform:translateY(-50%) rotate(90deg)}',
    '.sd-a{display:none;color:#D6D6CF;font-size:14px;line-height:1.65;padding:0 4px 15px;white-space:pre-line}',
    '.sd-item.sd-on .sd-a{display:block}',
    '.sd-none{color:#9E9E97;font-size:14px;padding:16px 0 4px}',
    '.sd-foot{flex:0 0 auto;border-top:1px solid #2E2E2A;padding:14px 20px 16px;background:#151513}',
    '.sd-cta{width:100%;box-sizing:border-box;background:#B8860B;color:#1A1A18;border:0;border-radius:11px;',
      'padding:13px;font:800 14.5px/1 Inter,sans-serif;cursor:pointer}',
    '.sd-cta:hover{background:#cf9a12}',
    '.sd-cta:focus-visible{outline:2px solid #fff;outline-offset:2px}',
    '.sd-back{background:0;border:0;color:#9E9E97;font:inherit;font-size:13.5px;cursor:pointer;padding:0 0 12px}',
    '.sd-back:hover{color:#fff}',
    '.sd-field{display:block;font-size:12.5px;font-weight:700;color:#fff;margin:12px 0 6px}',
    '.sd-in{width:100%;box-sizing:border-box;background:#222220;border:1px solid #3a3a35;border-radius:10px;',
      'padding:11px 13px;color:#fff;font:inherit;font-size:14.5px}',
    '.sd-in:focus{outline:0;border-color:#B8860B}',
    '.sd-in::placeholder{color:#7d776a}',
    'textarea.sd-in{min-height:96px;resize:vertical}',
    '.sd-msg{font-size:13.5px;margin-top:12px;line-height:1.55}',
    '.sd-msg.sd-err{color:#ff8a8a}',
    '.sd-msg.sd-ok{color:#4FC96E}',
