...
(function () {
  ...
  var CSS = [
    ...
    '.sd-cta{width:100%;box-sizing:border-box;background:#1A1A18;color:#FCF9F2;border:0;border-radius:11px;',
      'padding:13px;font:800 14.5px/1 Inter,sans-serif;cursor:pointer}',
    '.sd-cta:hover{background:#3D3A33}',
    '.sd-cta:focus-visible{outline:2px solid #8A6608;outline-offset:2px}',
    ...
    '.sd-msg.sd-ok{color:#1A1A18;font-weight:700}',
